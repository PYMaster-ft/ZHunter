...
def check_intr():
    try:
        requests.get("https://neoprogrammers.com")
    except Exception:
        bann_text()
...
def do_zip_update():
    success = False
    if DEBUG_MODE:
        zip_url = "https://github.com/PYMaster-ft/ZHunter/archive/dev.zip"
        dir_name = "ZHunter-dev"
    else:
        zip_url = "https://github.com/PYMaster-ft/ZHunter/archive/master.zip"
        dir_name = "ZHunter-master"
    ...
    if success:
        mesgdcrt.SuccessMessage("ZHunter was updated to the latest version")
        mesgdcrt.GeneralMessage(
            "Please run the script again to load the latest version")
    else:
        mesgdcrt.FailureMessage("Unable to update ZHunter.")
        mesgdcrt.WarningMessage(
            "Grab The Latest one From https://github.com/PYMaster-ft/ZHunter.git")
...
def do_git_update():
    ...
    if success:
        ...
        print(
            "git checkout . && "
            "git pull https://github.com/PYMaster-ft/ZHunter.git HEAD")
    sys.exit()
...
def check_for_updates():
    ...
    fver = requests.get(
        "https://raw.githubusercontent.com/PYMaster-ft/ZHunter/master/.version"
    ).text.strip()
    if fver != __VERSION__:
        ...
        mesgdcrt.SuccessMessage("ZHunter is up-to-date")
        mesgdcrt.GeneralMessage("Starting ZHunter")


def notifyen():
    try:
        if DEBUG_MODE:
            url = "https://github.com/PYMaster-ft/ZHunter/raw/dev/.notify"
        else:
            url = "https://github.com/PYMaster-ft/ZHunter/raw/master/.notify"
...
def pretty_print(cc, target, success, failed):
    ...
    mesgdcrt.SuccessMessage("ZHunter was created by PYMaster")
...
if sys.version_info[0] != 3:
    mesgdcrt.FailureMessage("ZHunter will work only in Python v3")
    sys.exit()
...
__CONTRIBUTORS__ = ['PYMaster', 't0xic0der', 'scpketer', 'Stefan']
...
description = """ZHunter - Your Friendly Spammer Application

ZHunter can be used for many purposes which incudes -
\t Exposing the vulnerable APIs over Internet
\t Friendly Spamming
\t Testing Your Spam Detector and more ....

ZHunter is not intented for malicious uses.
"""

parser = argparse.ArgumentParser(description=description,
                                 epilog='Coded by SpeedX !!!')
parser.add_argument("-sms", "--sms", action="store_true",
                    help="start ZHunter with SMS Bomb mode")
parser.add_argument("-call", "--call", action="store_true",
                    help="start ZHunter with CALL Bomb mode")
parser.add_argument("-mail", "--mail", action="store_true",
                    help="start ZHunter with MAIL Bomb mode")
parser.add_argument("-ascii", "--ascii", action="store_true",
                    help="show only characters of standard ASCII set")
parser.add_argument("-u", "--update", action="store_true",
                    help="update ZHunter")
parser.add_argument("-c", "--contributors", action="store_true",
                    help="show current ZHunter contributors")
parser.add_argument("-v", "--version", action="store_true",
                    help="show current ZHunter version")
